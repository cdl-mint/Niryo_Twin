...
def main():
    ...
    try:
        ...
        # TODO: ADD YOUR custom_target_positions_list HERE: eg is given below

        # custom_target_positions_list = [
        #     [0, 0, 0, 0, 0, 0],
        ...
        for i, target_joint_positions in enumerate(custom_target_positions_list):
